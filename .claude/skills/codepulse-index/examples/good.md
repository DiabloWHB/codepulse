...
```javascript
// Step 1: Query index
const emailContext = await vscode.commands.executeCommand(
  'codepulse.getAIContext',
...
const component = await vscode.commands.executeCommand(
  'codepulse.getAIContext',
...
const routes = await vscode.commands.executeCommand(
  'codepulse.getAIContext',
